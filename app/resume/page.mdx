...
ICT Technician diploma confirming professional qualifications in the profession of a telecommunications,
with the specified qualifications:
* **EE.10** - Assembly, commissioning, and maintenance of teleinformatics devices and networks.
* **EE.11** - Administration of network operating systems and computer networks.
