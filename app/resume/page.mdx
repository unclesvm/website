...
<div className="w-full grid grid-cols-2 md:grid-cols-4 gap-2 my-2">
  <a href="https://svm.engineer" className="flex justify-center items-center gap-2 ">
    <img
      height="16"
      width="16"
  ...
  <a href="https://linkedin.com/in/sam-kmn" className="flex justify-center items-center gap-2 ">
    <img
      height="16"
      width="16"
      style={{ filter: 'invert(1)' }}
  ...
  <a href="https://github.com/shadsvm" className="flex justify-center items-center gap-2">
    <img
      height="16"
      width="16"
      style={{ filter: 'invert(1)' }}
  ...
  <a href="mailto:mailf@svm.engineer" className="flex justify-center items-center gap-2">
    <img
      height="16"
      width="16"
      style={{ filter: 'invert(1)' }}
      src="https://cdn.jsdelivr.net/npm/simple-icons@v13/icons/mailgun.svg"
    />
    email
  </a>
</div>
